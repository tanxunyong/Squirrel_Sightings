    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Unique_Squirrel_ID', models.CharField(help_text='Unique Squirrel ID', max_length=13, null=True)),
                ...
                ('Age', models.CharField(blank=True, choices=[('Adult', 'Adult'), ('Juvenile', 'Juvenile'), ('Unknown', '?'), ('', '')], default='', help_text='Squirrel Age', max_length=10, null=True)),
